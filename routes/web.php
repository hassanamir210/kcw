...
//public rroute
Route::get('ipnbtc', 'Auth\PaymentManagementController@ipnbtc');
...
Route::group(['middleware' => [config('access.users.super_admin'),config('access.two_factor_auth')],'prefix' => 'admin', 'as' => 'admin.','namespace' => 'Auth\Admin'], function () {
    ...
    Route::get('list/redeems', 'PaymentRequestController@listRedeems');
    Route::get('add/redeem/{id}', 'PaymentRequestController@addRedeem');
});
