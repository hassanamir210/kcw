...
<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
    ...
    <div class="container" style="text-align: center;">
        @if(auth()->user()->id!=1)
            <a href="{{url('/user/token-buy-stats/w')}}" type="button" class="btn btn-primary">7 Days</a>
            <a href="{{url('/user/token-buy-stats/m')}}" type="button" class="btn btn-warning">30 Days </a>
            <a href="{{url('/user/token-buy-stats/y')}}" type="button" class="btn btn-success">12 Months</a>
        @else
