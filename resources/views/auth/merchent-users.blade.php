        ...
        <div class="kt-portlet__body">
            <div class="users-table-container">
                <table class="table table-striped- table-bordered table-hover table-checkable table-data_table" >
                    ...
                    <tbody>
                        @foreach(auth()->user()->getUserReferralTree() as $user)
                        <tr>
                            ...
                            <td>
                                <a href="{{ url('/user/payment/deposit',$user->id) }}" data-toggle="tooltip" data-placement="top" title="@lang('Depost')" class="btn btn-dark">
                                    Deposit
                                </a>
                            </td>
                        </tr>
